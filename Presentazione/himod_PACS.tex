...
%Per tanti pacchetti
% Estende il contatore di pacchetti
\usepackage{etex}
%================
...
\titlegraphic{\includegraphics[scale=0.3]{Varie/logo-polimi}}
...
\tableofcontents
\end{frame}
\include{Contents/Teoria}
\include{Contents/Implementazione}
\include{Contents/Risultati}
\titleslide{Fine}
\appendix
\include{Contents/Extras}
\end{document}