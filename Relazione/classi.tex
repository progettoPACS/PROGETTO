...
\classe{ModalSpace} conosce la geometria della sezione (Ly, Lz) e deve conoscere il grado di accuratezza desiderato 
...
Diamo un breve descrizione delle strutture dati possedute dalla classe \classe{ModalSpace}. Prima di cominciare vorremmo 
...
\end{lstlisting}
 ...
 ed il loro impiego sar\`a pi\`u una volta vista la classe \classe{HiModAssembler}.
